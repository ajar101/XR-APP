...
# Basis data pengguna & jejak audit. WAJIB dipasangi volume yang awet —
# kalau tidak, seluruh akun dan jejak auditnya hilang tiap container dibuat
# ulang, dan admin pertama harus dibuat lagi dari nol.
RUN mkdir -p /app/data && chown xrapp:xrapp /app/data
VOLUME ["/app/data"]
