...
class BNIStatementExtractor(NamaLawanBNI, PencatatPeringatan, BaseExtractor):
    """
    Nama lawan transaksi dibaca pipeline bersama extractors/bni_nama.py —
    kolom keterangan format ini bertata bahasa sama dengan TRANSACTION
    INQUIRY, jadi aturannya tidak disalin ke dua tempat.
    """
